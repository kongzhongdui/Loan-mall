...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading"><font color="gray">基金超市</font></h2>
		...
		<label class="radio inline">
			<input id="dormManager" type="radio" name="userType" value="dormManager" ${userType==2?'checked':''} /> 客户
		</label>
		...
		<p align="center" style="padding-top: 15px;">版权所有  2021  Lero  <a href="http://www.lero.com" target="_blank">http://www.lero.com</a></p>
      </form>
</div>
</body>
</html>